...
_DATA_URL = 'http://download.tensorflow.org/example_images/'+FLAGS.dataset_name+'_photos.tgz'

# The number of images in the validation set.
_NUM_VALIDATION = int(rt/9)
...
def _get_filenames_and_classes(dataset_dir):
  ...
  """
  img_root = os.path.join(dataset_dir, '')
  directories = []
  class_names = []
...
def _clean_up_temporary_files(dataset_dir):
  ...
  cname = sys.argv[1]
  tmp_dir = os.path.join(dataset_dir,cname+'_photos')
